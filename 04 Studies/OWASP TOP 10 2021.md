...
-  app allows brute force with no account lockout 
    
-   using weak methods for password recovery 
    
- Not inforcing 2FA
    
-   Weak password policy
    
- insecure session storing
    
-   using weak methods for password recovery 
    
- Default creds
  
- storing passwords in plain text or weak hashing algorithm  
...
- Stronger password policy, Not allowing users to use weak passwords
- session timeout, server side session management 
